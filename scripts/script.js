...
function update() {
  ...
  var createScene = function() {
    ...
    //Função para mostrar os eixos que recebe o parâmetro do tamanho deles
    var showAxis = function(size) {
      var axisX = BABYLON.Mesh.CreateLines("axisX", [
          BABYLON.Vector3.Zero(),
          new BABYLON.Vector3(size, 0, 0) ], scene);
      axisX.color = BABYLON.Color3.Red();
      /*var cylinderX = BABYLON.Mesh.CreateCylinder("cylinder",
          0.5, 0.0001, size, 36, scene);
      var cylMatR = new BABYLON.StandardMaterial("cylR", scene);
      cylMatR.diffuseColor = new BABYLON.Color3(1, 0, 0);
      cylinderX.material = cylMatR;
      cylinderX.rotation.z = -Math.PI / 2;
      cylinderX.position = new BABYLON.Vector3(size + 0.25, 0, 0);*/
      var axisY = BABYLON.Mesh.CreateLines("axisY", [
          BABYLON.Vector3.Zero(),
          new BABYLON.Vector3(0, size, 0) ], scene);
      axisY.color = BABYLON.Color3.Green();
      /*var cylinderY = BABYLON.Mesh.CreateCylinder("cylinder",
          0.5, 0.0001, 0.3, 36, scene);
      var cylMatG = new BABYLON.StandardMaterial("cylG", scene);
      cylMatG.diffuseColor = new BABYLON.Color3(0, 1, 0);
      cylinderY.material = cylMatG;
      cylinderY.setPivotMatrix(BABYLON.Matrix.Translation(0,
          size + 0.25, 0));*/
      var axisZ = BABYLON.Mesh.CreateLines("axisZ", [
          BABYLON.Vector3.Zero(),
          new BABYLON.Vector3(0, 0, size) ], scene);
      axisZ.color = BABYLON.Color3.Blue();
      /*var cylinderZ = BABYLON.Mesh.CreateCylinder("cylinder",
          0.5, 0.0001, 0.3, 36, scene);
      var cylMatB = new BABYLON.StandardMaterial("cylB", scene);
      cylMatB.diffuseColor = new BABYLON.Color3(0, 0, 1);
      cylinderZ.material = cylMatB;
      cylinderZ.rotation.x = Math.PI / 2;
      cylinderZ.position = new BABYLON.Vector3(0, 0, size + 0.25);*/
    }
